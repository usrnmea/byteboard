...
/// Because of the constant change in evaluations, tests are very difficult to do.
/// That's why testing is done on the most basic things. For example, if there
/// is an obvious white advantage, the function does not return DRAW or less.

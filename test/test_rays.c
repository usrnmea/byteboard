...
void test_get_ray_diagonal(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(0x100000000000000ULL, get_ray_diagonal(SQ_A8));
    TEST_ASSERT_EQUAL_UINT64(0x80ULL, get_ray_diagonal(SQ_H1));
}

void test_get_ray_anti_diagonal(void)
{
    TEST_ASSERT_EQUAL_UINT64(0X8000000000000000ULL, get_ray_anti_diagonal(SQ_H8));
    TEST_ASSERT_EQUAL_UINT64(0X1ULL, get_ray_anti_diagonal(SQ_A1));
    TEST_ASSERT_EQUAL_UINT64(0X102040810204080ULL, get_ray_anti_diagonal(SQ_A8));
}
...
void test_get_ray_north_east(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(0X8040201008040200ULL, get_ray_north_east(SQ_A1));
...
void test_get_ray_north_west(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(0X102040810204000ULL, get_ray_north_west(SQ_H1));
...
void test_get_ray_south_east(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64(0X2040810204080ULL, get_ray_south_east(SQ_A8));
